...
</code></pre><h2 id="Rutas-Auth" data-id="Rutas-Auth"><a class="anchor hidden-xs" href="#Rutas-Auth" title="Rutas-Auth"><span class="octicon octicon-link"></span></a><span>Rutas Auth</span></h2><hr><h3 id="POST" data-id="POST"><a class="anchor hidden-xs" href="#POST" title="POST"><span class="octicon octicon-link"></span></a><span>POST</span></h3><p><span>Registra un nuevo usuario con rol:USER</span></p><pre><code>/api/register
...
</code></pre><h3 id="POST1" data-id="POST"><a class="anchor hidden-xs" href="#POST1" title="POST1"><span class="octicon octicon-link"></span></a><span>POST</span></h3><p><span>Permite a un usuario registrado obtener un token para realizar peticiones</span></p><pre><code>/api/login
</code></pre><h5 id="BODY1" data-id="BODY"><a class="anchor hidden-xs" href="#BODY1" title="BODY1"><span class="octicon octicon-link"></span></a><span>BODY</span></h5><pre><code>email:email
password:string
...
errors: [email?, password? ], Error?
</code></pre><h2 id="Rutas-Autenticadas" data-id="Rutas-Autenticadas"><a class="anchor hidden-xs" href="#Rutas-Autenticadas" title="Rutas-Autenticadas"><span class="octicon octicon-link"></span></a><span>Rutas Autenticadas</span></h2><hr><h3 id="GET" data-id="GET"><a class="anchor hidden-xs" href="#GET" title="GET"><span class="octicon octicon-link"></span></a><span>GET</span></h3><p><span>Verifica el rol de un usuario</span></p><pre><code>/api/verify/{email}
...
</code></pre><p><span>Se genera un token al momento de loguearse</span></p><h3 id="GET1" data-id="GET"><a class="anchor hidden-xs" href="#GET1" title="GET1"><span class="octicon octicon-link"></span></a><span>GET</span></h3><p><span>Consulta el perfil de un usuario registrado</span></p><pre><code>/api/profile/{NOMBRE_USUARIO}
...
</code></pre><p><span>El token se genera cuando el usuario se registra o se loguea.</span></p><h3 id="PUT" data-id="PUT"><a class="anchor hidden-xs" href="#PUT" title="PUT"><span class="octicon octicon-link"></span></a><span>PUT</span></h3><p><span>Actualiza el perfil de un usuario registrado</span></p><pre><code>/api/profile/{NOMBRE_USUARIO}
...
message:string
</code></pre><h3 id="DELETE" data-id="DELETE"><a class="anchor hidden-xs" href="#DELETE" title="DELETE"><span class="octicon octicon-link"></span></a><span>DELETE</span></h3><p><span>Elimina un usuario</span></p><pre><code>/api/profile/{NOMBRE_USUARIO}
...
<li><a href="#POST1" title="POST">POST</a></li>
</ul>
</li>
<li><a href="#Rutas-Autenticadas" title="Rutas Autenticadas">Rutas Autenticadas</a><ul class="nav">
<li><a href="#GET" title="GET">GET</a></li>
<li><a href="#GET1" title="GET">GET</a></li>
<li><a href="#PUT" title="PUT">PUT</a></li>
