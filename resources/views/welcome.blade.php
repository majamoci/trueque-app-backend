...
<body id="preview" cz-shortcut-listen="true">
  <h2 class="code-line" data-line-start="0" data-line-end="1"><a id="URL_0"></a>URL</h2>
  <pre><code class="has-line-data" data-line-start="2" data-line-end="4">https://trueque-admin.herokuapp.com
</code></pre>
  <h3 class="code-line" data-line-start="4" data-line-end="5"><a id="GET_4"></a>GET</h3>
  <pre><code class="has-line-data" data-line-start="6" data-line-end="8">/api/profile/{NOMBRE_USUARIO}
</code></pre>
  <p class="has-line-data" data-line-start="8" data-line-end="9">Consulta el perfil del usuario.</p>
  <h5 class="code-line" data-line-start="10" data-line-end="11"><a id="HEADERS_10"></a>HEADERS</h5>
  <pre><code class="has-line-data" data-line-start="12" data-line-end="14">Bearer token
</code></pre>
  <p class="has-line-data" data-line-start="14" data-line-end="15">El token se genera cuando el usuario se registra o se
    loguea.</p>
  <h3 class="code-line" data-line-start="15" data-line-end="16"><a id="POST_15"></a>POST</h3>
  <pre><code class="has-line-data" data-line-start="17" data-line-end="19">/api/register
</code></pre>
  <h5 class="code-line" data-line-start="19" data-line-end="20"><a id="BODY_19"></a>BODY</h5>
  <pre><code class="has-line-data" data-line-start="21" data-line-end="25">name:string
email:email
password:string
</code></pre>
  <p class="has-line-data" data-line-start="25" data-line-end="26">Se genera un token al momento de registrarse</p>
  <h3 class="code-line" data-line-start="27" data-line-end="28"><a id="POST_27"></a>POST</h3>
  <pre><code class="has-line-data" data-line-start="29" data-line-end="31">/api/login
</code></pre>
  <h5 class="code-line" data-line-start="31" data-line-end="32"><a id="BODY_31"></a>BODY</h5>
  <pre><code class="has-line-data" data-line-start="33" data-line-end="36">email:email
password:string
</code></pre>
  <p class="has-line-data" data-line-start="36" data-line-end="37">Se genera un token al momento de loguearse</p>
  <h3 class="code-line" data-line-start="38" data-line-end="39"><a id="PUT_38"></a>PUT</h3>
  <pre><code class="has-line-data" data-line-start="40" data-line-end="42">/api/profile
</code></pre>
  <h5 class="code-line" data-line-start="42" data-line-end="43"><a id="HEADERS_42"></a>HEADERS</h5>
  <pre><code class="has-line-data" data-line-start="44" data-line-end="46">Bearer token
</code></pre>
  <h5 class="code-line" data-line-start="46" data-line-end="47"><a id="BODY_46"></a>BODY</h5>
  <pre><code class="has-line-data" data-line-start="48" data-line-end="64">firstname:string
lastanme:string
...
insterests:string (lista de items, separados en comas)
  ...
  <h3 class="code-line" data-line-start="65" data-line-end="66"><a id="DELETE_65"></a>DELETE</h3>
  <pre><code class="has-line-data" data-line-start="67" data-line-end="69">/api/profile/{NOMBRE_USUARIO}
</code></pre>
  <h5 class="code-line" data-line-start="69" data-line-end="70"><a id="HEADERS_69"></a>HEADERS</h5>
  <pre><code class="has-line-data" data-line-start="71" data-line-end="73">Bearer token
</code></pre>
</body>
